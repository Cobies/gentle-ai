...
`
	...
	first, err := InjectForSync(home, home, opencodeAdapter(), model.PersonaGentleman)
	if err != nil {
	...
	second, err := InjectForSync(home, home, opencodeAdapter(), model.PersonaGentleman)
	if err != nil {
...
func TestInjectForSyncOpenCodeGentlemanSucceedsWithoutSettings(t *testing.T) {
	...
	result, err := InjectForSync(home, home, opencodeAdapter(), model.PersonaGentleman)
	if err != nil {
		t.Fatalf("InjectForSync() error = %v", err)
	}
	if !result.Changed {
