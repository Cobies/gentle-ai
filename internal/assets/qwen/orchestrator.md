...
Use Qwen's native bounded worker for delegated-direct work.
...
Convention files under `~/.qwen/skills/_shared/` (global) or `.agent/skills/_shared/` (workspace): `engram-convention.md`, `persistence-contract.md`.
