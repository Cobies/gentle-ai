...
- Scan user skills: `~/.pi/agent/skills/`, `~/.config/agents/skills/`, `~/.agents/skills/`, `~/.kimi/skills/`, `~/.config/opencode/skills/`, `~/.config/kilo/skills/`, `~/.claude/skills/`, `~/.gemini/skills/`, `~/.gemini/antigravity-cli/skills/`, `~/.gemini/antigravity-desktop/skills/`, `~/.gemini/antigravity/skills/` (legacy), `~/.cursor/skills/`, `~/.copilot/skills/`, `~/.codex/skills/`, `~/.codeium/windsurf/skills/`, `~/.qwen/skills/`, `~/.kiro/skills/`, and `~/.openclaw/skills/`. The Antigravity scan covers Mission Control CLI (`antigravity-cli`), Mission Control desktop (`antigravity-desktop`), and the legacy bare `antigravity` location additively; new installs prefer the variant-specific dirs.
